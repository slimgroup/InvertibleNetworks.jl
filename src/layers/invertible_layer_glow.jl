...
function CouplingLayerGlow(n_in::Int64, n_hidden::Int64; freeze1x1=false, k1=3, k2=1, p1=1, p2=0, s1=1, s2=1, logdet=false, activation::ActivationFunction=SigmoidLayer(), ndims=2)

    # 1x1 Convolution and residual block for invertible layer
    C = Conv1x1(n_in; freeze=freeze1x1)
