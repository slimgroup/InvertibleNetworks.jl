...
function ConditionalLayerHINT(n_in::Int64, n_hidden::Int64;max_recursion=1, k1=3, k2=3, p1=1, p2=1, s1=1, s2=1,
                              logdet=true, permute=true, ndims=2, activation::ActivationFunction=SigmoidLayer())

    # Create basic coupling layers
    CL_X = CouplingLayerHINT(n_in, n_hidden;max_recursion=max_recursion, activation=activation,k1=k1, k2=k2, p1=p1, p2=p2, s1=s1, s2=s2, logdet=logdet, permute="none", ndims=ndims)
    CL_Y = CouplingLayerHINT(n_in, n_hidden;max_recursion=max_recursion, activation=activation,k1=k1, k2=k2, p1=p1, p2=p2, s1=s1, s2=s2, logdet=logdet, permute="none", ndims=ndims)
