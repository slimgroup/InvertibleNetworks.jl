...
# Constructor
function NetworkGlow(n_in, n_hidden, L, K; freeze1x1=false, split_scales=false, k1=3, k2=1, p1=1, p2=0, s1=1, s2=1, ndims=2, squeezer::Squeezer=ShuffleLayer(), activation::ActivationFunction=SigmoidLayer())
    ...
    for i=1:L
        ...
        for j=1:K
            ...
            CL[i, j] = CouplingLayerGlow(n_in, n_hidden; freeze1x1=freeze1x1, k1=k1, k2=k2, p1=p1, p2=p2, s1=s1, s2=s2, logdet=true, activation=activation, ndims=ndims)
        end
