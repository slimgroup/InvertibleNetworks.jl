...
# Constructor
function NetworkHINT(n_in, n_hidden, depth; k1=3, k2=3, p1=1, p2=1, s1=1, s2=1, logdet=true, ndims=2)
    ...
    for j=1:depth
        ...
        CL[j] = CouplingLayerHINT(n_in, n_hidden; permute="full", k1=k1, k2=k2, p1=p1,
                                  p2=p2, s1=s1, s2=s2, logdet=logdet, ndims=ndims)
    end
