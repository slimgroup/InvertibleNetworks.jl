...
# Constructor
function NetworkConditionalGlow(n_in, n_cond, n_hidden, L, K; Unet_t=nothing,freeze_conv=false,  split_scales=false,  rb_activation::ActivationFunction=ReLUlayer(), k1=3, k2=1, p1=1, p2=0, s1=1, s2=1, ndims=2, squeezer::Squeezer=ShuffleLayer(), activation::ActivationFunction=SigmoidLayer())
    ...
    for i=1:L
        ...
        for j=1:K
            ...
            CL[i, j] = ConditionalLayerGlow(n_in, n_cond, n_hidden;Unet_t=Unet_t,freeze_conv=freeze_conv,  rb_activation=rb_activation, k1=k1, k2=k2, p1=p1, p2=p2, s1=s1, s2=s2, logdet=true, activation=activation, ndims=ndims)
        end
