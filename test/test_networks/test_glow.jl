...
split_scales = true
dense = true
for (nx,L) in [(32,2),(2,1)] # nx=2 is difficult because can only do one multiscale
    N = (nx)
    println("Testing Dense Glow with dimensions nx=$(N) and split_scales=$(split_scales)")
    # Network and input
