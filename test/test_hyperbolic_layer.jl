...
# Layer
H1 = HyperbolicLayer(nx, ny, n_in, batchsize, k, s, p; action="down", α=.1f0, n_hidden=128)
...
H0 = HyperbolicLayer(nx, ny, n_in, batchsize, k, s, p; action="down", α=.1f0, n_hidden=128)
Hini = deepcopy(H0)
