...
C = Conv1x1(k)
RB = FullyConvBlock(nx, ny, n_in, n_hidden, batchsize; k1=3, k2=3, p1=1, p2=1, fan=true)
...
# Invertible layers
C0 = Conv1x1(k)
RB0 = FullyConvBlock(nx, ny, n_in, n_hidden, batchsize; k1=3, k2=3, p1=1, p2=1, fan=true)
