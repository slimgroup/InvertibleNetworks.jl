...
# Weights
W1 = 1f0*glorot_uniform(k1, k1, n_in, n_hidden)
W2 = 1f0*glorot_uniform(k2, k2, n_hidden, n_hidden)
W3 = 1f0*glorot_uniform(k1, k1, 2*n_in, n_hidden)
b1 = 1f0*glorot_uniform(n_hidden)
b2 = 1f0*glorot_uniform(n_hidden)

W01 = 1f0*glorot_uniform(k1, k1, n_in, n_hidden)
W02 = 1f0*glorot_uniform(k2, k2, n_hidden, n_hidden)
W03 = 1f0*glorot_uniform(k1, k1, 2*n_in, n_hidden)
b01 = 1f0*glorot_uniform(n_hidden)
b02 = 1f0*glorot_uniform(n_hidden)
...
# Residual blocks
RB = FullyConvBlock(W1, W2, W3, b1, b2, nx, ny, batchsize)   # true weights
...
RB0 = FullyConvBlock(W01, W02, W03, b1, b2, nx, ny, batchsize)   # initial weights
...
RB0 = FullyConvBlock(W1, W2, W3, b01, b02, nx, ny, batchsize)
